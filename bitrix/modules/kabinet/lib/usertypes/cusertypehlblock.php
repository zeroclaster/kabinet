...
class CKabinetUserTypeHlblock extends EnumType
{
    public const RENDER_COMPONENT = 'exi:main.field.enumuser';
	public const USER_TYPE_ID = 'kabinethlblock';
	...
	{
		return [
			'DESCRIPTION' => 'с допами к highload-блоков',
