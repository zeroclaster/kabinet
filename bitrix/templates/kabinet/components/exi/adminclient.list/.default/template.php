...
<script type="text/html" id="kabinet-content">
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <table class="table" style="width: 100%;">
                <tbody>
                <tr>
                    <td width="10%">Клиент</td>
                    <td style="width: 28%;">Проекты</td>
                    <td style="width: 44%;">Задачи</td>
                    <td style="width: 20%;">Исполнения</td>
                </tr>
                </tbody>
            </table>
    ...
    <div class="d-flex justify-content-center">
        <div class="d-flex align-items-center">Найдено {{total}}, показано {{this.dataclient?.length || 0}}</div>
...
<script>
    ...
    window.addEventListener("components:ready", function(event) {
        ...
        adminClientListApplication._component.data = () => ({
            countview: Number(PHPPARAMS.viewcount),
            total: Number(PHPPARAMS.total),
