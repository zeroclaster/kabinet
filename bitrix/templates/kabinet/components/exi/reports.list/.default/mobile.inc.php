            ...
            <div class="ml-auto">
                ...
                <div class="panel report-list-block" v-for="(runner,runnerindex) in datarunner">
                    <div class="panel-body p-0">
                        ...
                        <!-- ссылка -->
                        <div class="report-mytypeahead-1">
                        ...
                        <template v-if="TaskByIdKey[runner.UF_TASK_ID].UF_MANAGER_ID>0">
                            ...
                            <div v-if="hiddenCommentBlock.isShow(runner)">
                                <messangerperformances :isMobile="<?=isMobileDevice()?>" :projectID="TaskByIdKey[runner.UF_TASK_ID].UF_PROJECT_ID" :taskID="runner.UF_TASK_ID" :queue_id="runner.ID" :targetUserID="TaskByIdKey[runner.UF_TASK_ID].UF_MANAGER_ID"/>
                            </div>
                        </template>
