...
<div class="d-flex justify-content-between">
    ...
    <div class="pagehelp-button text-primary" data-component="pagehelp" data-code="DOGOVOR" style="margin-right: 15px;"><i class="fa fa-question-circle text-warning" aria-hidden="true"></i> Помощь</div>
</div>
